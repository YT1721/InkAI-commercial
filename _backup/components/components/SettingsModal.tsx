...
import { X, Save, Key, ExternalLink, Sparkles, Zap, MessageCircle, Globe } from 'lucide-react';
        ...
        <div className="p-6 space-y-8 overflow-y-auto custom-scrollbar flex-1">
          ...
          <div className="space-y-4">
            ...
            <button 
                ...
                className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl py-4 transition-all group"
            >
